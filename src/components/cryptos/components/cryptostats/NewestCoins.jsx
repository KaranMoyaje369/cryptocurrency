...
const NewestCoins = ({ newestCoins, isLoading, isError }) => {
  // console.log("newCoin:", newestCoins);

  const HistoricalData = ({ uuid }) => {
    // console.log("Fetching history for NewCoin:", uuid);
    const { history } = useCryptoHistory(uuid);
    // console.log("HnewCoin", history);
